                    ...
                    return (
                        <div key={beatmap.SetID} className="col-xs-12 col-sm-12 col-lg-3">
                            <div className="thumbnail thumby">
                                <a href={`http://storage.ripple.moe/d/${beatmap.SetID}`} target="_blank">
                                ...
                                <div className="caption">
                                    ...
                                    <a href={`http://storage.ripple.moe/d/${beatmap.SetID}`} target="_blank" className="btn btn-default btn-xs pull-right" role="button"><i className="fa fa-download"></i></a>
                                    <a href={`http://storage.ripple.moe/d/${beatmap.SetID}`} target="_blank" className="btn btn-info btn-xs download-button" role="button">Download</a> 
