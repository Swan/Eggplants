...
config.SITE_NAME = 'Eggplants';
config.HELLO = "Eggplants!";
config.TAGLINE = "Passami una melanzana~!";
...
config.CONTACTS = [
	"<b>Swan</b><br/>"+
	"Email: <a href='mailto:the@swan.moe'>the@swan.moe</a><br/>"+
	"Twitter: <a href='http://twitter.com/ImagineSwan'>@ImagineSwan</a><br/>"+
	"Github: <a href='https://github.com/Swan'>Swan</a>",
	""
];
